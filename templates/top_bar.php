...
<!-- 						<li class="dropdown profile-dropdown">
						...
						<li class="dropdown profile-dropdown">
							<a href="#" class="dropdown-toggle" >
								...
								<span class="hidden-xs"><?php echo $this->session->userdata('username'); ?></b></span>
							</a>
						</li>
						<li class="hidden-xxs " >
						...
						<li class="hidden-xxs " >
							<select class="form-control select2"  name="role_user" id="role_user" style="width: 100%; margin-top: 8px;">	
								<option value="<?php echo $user_role->INV_ROLE_ID ?>"<?=$user_role->INV_ROLE_ID == $this->session->userdata('role_id') ? ' selected="selected"' : '';?>><?php echo $user_role->INV_ROLE_NAME ?></option>
						...
						<li class="hidden-xxs " >
							<select class="form-control select2"  name="unit_role" id="unit_role" style="width: 100%; margin-top: 8px;">	<option value="ALL_UNIT"<?= "ALL_UNIT" == $this->session->userdata('unit_id_val') ? ' selected="selected"' : '';?> >ALL UNIT</option>
								<?php foreach ($unit_code as $key => $value) { ?>
								<option value="<?php echo $value->INV_UNIT_CODE ?>" <?=$value->INV_UNIT_CODE == $this->session->userdata('unit_id_val') ? ' selected="selected"' : '';?> ><?php echo $value->INV_UNIT_CODE ?></option>
								<?php } ?>
							</select>
