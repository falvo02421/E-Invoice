...
<?php //header("X-FRAME-OPTIONS: DENY");
      header('X-Frame-Options: ALLOW-FROM http://172.16.254.51/');
?>
<html>
<head>
	<meta charset="UTF-8" />
  ...
  <link rel="stylesheet" type="text/css" href="<?=CUBE_?>css/bootstrap/bootstrap-datepicker.css" />
	...
	<link rel="stylesheet" href="<?=CUBE_?>css/libs/jquery.datetimepicker.min.css" type="text/css" />
	...
	<script src="<?=CUBE_?>js/jquery.dataTables.min.js"></script>
	<script src="<?=CUBE_?>js/dataTables.fixedHeader.js"></script>
	<script src="<?=CUBE_?>js/dataTables.tableTools.js"></script>
	<script src="<?=CUBE_?>js/dataTables.tableTools.min.js"></script>
	...
	<script src="<?=CUBE_?>js/validator.js"></script>
	<script>
	...
	<script src="<?=CUBE_?>js/jquery.datetimepicker.full.min.js"></script>
