					...
					<div class="box-body">
						<div class="form-group">
							<div class="col-sm-12 col-sm-8">
								<a type="submit" class="btn btn-primary btn-lg" data-toggle="" data-target="" href="<?php echo ROOT;?>einvoice/reporting/cetak_all_nota_excel">Export To Excel</a>
								<a type="submit" class="btn btn-primary btn-lg" data-toggle="model" target="_blank" href="<?php echo ROOT;?>einvoice/reporting/cetak_pengirimannota/nota">Print Report</a>
								<!--
