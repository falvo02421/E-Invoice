							...
							<div class="col-md-6">
								<div class="box-body">
									<div class="form-group">
										<div class="box-body">
											<label for="" class="col-sm-5 control-label">No Nota</label>
											<div class="row">
												<div class="col-xs-5">
									...
									<div class="form-group">
										<div class="box-body">
											<label for="" class="col-sm-5 control-label">No Pranota</label>
											<div class="row">
												<div class="col-xs-5">
													<input type="text" name="" id="" class="form-control" placeholder="No Pranota">
												</div>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="box-body">
											<label for="" class="col-sm-5 control-label">No BPRP</label>
											<div class="row">
												<div class="col-xs-5">
													<input type="text" name="" id="" class="form-control" placeholder="No BPRP">
												</div>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="box-body">
											<label for="" class="col-sm-5 control-label">No Uper</label>
											<div class="row">
												<div class="col-xs-5">
													<input type="text" name="" id="" class="form-control" placeholder="No Uper">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="box-body">
											<label for="" class="col-sm-5 control-label">Status Nota</label>
											<div class="row">
												<div class="col-xs-5">
									...
									<div class="form-group">
										<div class="box-body">
											<label for="" class="col-sm-5 control-label">Jenis Nota</label>
											<div class="row">
												<div class="col-xs-5">
					                  		<select for="" class="form-control select" style="width: 100%;">
