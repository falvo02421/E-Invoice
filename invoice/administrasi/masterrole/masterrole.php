								...
								<div class="box-body">
									<div class="form-group">
							            <div class="col-sm-offset-12 col-sm-3 text-right">
								              <button type="button" onclick="ClearSearch()" class="btn btn-primary btn-sm"> Clear</button>
		...
		<div class="box-body">
			<div class="form-group">
				<div class="text-right">
						<!-- <button class="btn-btn plus" onclick="link_unit();"><i class="fa fa-plus"></i></button> -->
					...
					<div class="row">
						<div class="col-xs-5">
							...
							<?php foreach($entitys as $entity) { ?>
								<option value="<?php echo $entity->INV_ENTITY_CODE;?>"><?php echo $entity->INV_ENTITY_CODE;?></option>
							<?php } ?>
							</select>
						</div>
			...
			<div class="row">
				<div class="col-xs-5">
					...
					<?php foreach($unit1 as $unitid) { ?>
						<option value="<?php echo $unitid->INV_UNIT_CODE;?>"><?php echo $unitid->INV_UNIT_CODE;?></option>
					<?php } ?>
					</select>
				</div>
			</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div style="background-color:#B22222;" class="modal-header">
     	...
     	<div class="modal-body">
        <label for="" class="col-sm-3 control-label">Acces Role</label>
			<div class="row">
				<div class="col-xs-5">
     	...
     	<div class="modal-body">
        <label for="" class="col-sm-3 control-label">Acces Role Description</label>
			<div class="row">
				<div class="col-xs-5">
     	...
     	<div class="modal-body">
				<label for="" class="col-sm-3 control-label">Role</label>
					<div class="row">
						<div class="col-xs-5">
							<select name="INV_ROLE_TYPE2" id="INV_ROLE_TYPE2"  class="form-control select2 select_role" style="width: 100%;">
								<option selected="selected" value="Super Admin">Super Admin</option>
								<option value="Admin Entity">Admin Entity</option>
								<option value="Admin Unit">Admin Unit</option>
								<option value="User">User</option>
		...
		<div class="modal-body entity-div2">
				<label for="" class="col-sm-3 control-label">Entity</label>
					<div class="row">
						<div class="col-xs-5">
		...
		<div class="modal-footer">
			<button  type="button"  id="submit" name="submit" onclick="check_validation2()" class="btn btn-primary" data-dismiss="modal">Update</button>
			<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
		</div>
...
function ClearAddNew(){
	...
	function check_validation() {
		...
		}else if(INV_ROLE_TYPE1 == "Admin Unit"){
