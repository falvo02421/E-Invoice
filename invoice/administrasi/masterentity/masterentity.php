	...
	<div class="box-body">
		<div class="form-group">
			<div class="text-right">
			    ...
			    <button  type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add_entity"><i class="fa fa-plus"></i></button>
			</div>
		</div>
	</div>
</div>
												...
												<div class="box-body">
													<div class="form-group">
														<div class="text-left">
                                                           ...
                                                           <button type="button" class="btn btn-primary btn-sm" onclick="check_validation()">Save</button>
...
/*
    ...
    INV_ENTITY_ID:entityID
			...
			try {
					var result = JSON.parse(data);
					if(INV_EMATERAI_NUMBER = "" || INV_EMATERAI_REDAKSI == "" || INV_EMATERAI_EFECTIVE1 == "" || INV_EMATERAI_END1 == ""){
						$("#blank_form").modal();
					}
					else{
						if (result.status == "success") {
    ...
    INV_ENTITY_ID:entityID
		// INV_FAKTUR_STATUS:INV_FAKTUR_STATUS
			...
			if(INV_FAKTUR_NOTE == "" || INV_FAKTUR_EFECTIVE == "" || INV_FAKTUR_EXPIRED == ""){
				$("#blank_form").modal();
				$('#update-faktur').modal('show');
			}else{
				loaddatafaktur($('[name="ROWID"]').val());
