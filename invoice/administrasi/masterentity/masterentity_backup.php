					...
					<div class="row">
				  		<form class="form-horizontal" action="#" method="post" id="formSearch">
							...
							<div class="col-md-9">
								<div class="box-body">
									<div class="form-group">
							            <div class="col-sm-offset-12 col-sm-3 text-right">
...
<div id="allert_entity" class="modal fade top-modal" role="dialog" data-backdrop="static">
...
<div id="allert_entity_update" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_materai_update"   class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_faktur_update" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_materai_edit" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_faktur_edit" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_bank" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_sigin_edit" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_sigin_update" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_bank_update" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="allert_signbank" class="modal fade top-modal" role="dialog" data-backdrop="static">
	<div class="modal-dialog">
		<div class="modal-content">
	        <div style="background-color:#B22222;" class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="add_entity" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
	        ...
	        <div class="modal-body">
			<!-- <form id="form1" method="post" action="javascript:void(0);" class="form-horizontal"> -->
		            <div class="form-group">
	                	<div class="box-body">
							<div class="main-box-body clearfix">
								<div class="tabs-wrapper">
									<ul class="nav nav-tabs">
										...
										<li class="disabled" id="tabMaterai"><a id="tabMateraia" onclick="alertwarning()" href="#" >Materai</a></li>
										<li class="disabled" id="tabFaktur"><a onclick="alertwarning()" href="#" >Faktur Pajak</a></li>
									</ul>
									<div class="tab-content">
										<div class="tab-pane fade in active" id="tab-home">
											<form name="form_add_entity" class="form-horizontal" id="formAddEntity"><!-- enctype="multipart/form-data"-->
												<div class="box-body">
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																...
																<img id="uploadPreview" style="width: 210px; height: 120px;"/>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="box-body">
													<div class="form-group">
														<div class="text-left">
                                                           ...
                                                           <button type="button" class="btn btn-primary" onclick="check_validation()">Save</button>
													...
													<div class="form-group">
														...
														<div class="row">
															...
															<div class="col-xs-5">
																...
																<img id="uploadPreviewEdit" style="width: 210px; height: 120px;"/>
															</div>
														</div>
													</div>
												</div>
											...
											<table id="table-example" class="table table-hover">
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text" name="INV_FAKTUR_EFECTIVE1" id="INV_FAKTUR_EFECTIVE1" class="form-control" placeholder="dd/mm/yyyy">
															</div>
														</div>
													</div>
												</div>
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text" name="INV_FAKTUR_EXPIRED1" id="INV_FAKTUR_EXPIRED1" class="form-control" placeholder="dd/mm/yyyy">
															</div>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="box-body">
														<div class="form-group">
															<div class="text-right">
															   <button  type="button" class="btn btn-primary" onclick="check_validation2()">Save</button>
											...
											<form action="javascript:void(0);" class="form-horizontal" id="formAddMaterai" >
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<textarea type="text" name="INV_EMATERAI_REDAKSI1" id="INV_EMATERAI_REDAKSI1" class="form-control" placeholder="Redaksi E-Materai"></textarea>
															</div>
														</div>
													</div>
												</div>
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text" name="INV_EMATERAI_EFECTIVE1" id="INV_EMATERAI_EFECTIVE1" class="form-control" placeholder="dd/mm/yyyy">
															</div>
														</div>
													</div>
												</div>
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text" name="INV_EMATERAI_END1" id="INV_EMATERAI_END1" class="form-control" placeholder="dd/mm/yyyy">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="box-body">
														<div class="form-group">
															<div class="text-right">
															    <button  type="button" class="btn btn-primary" onclick="check_validation1()">Save</button>
															</div>
														</div>
													</div>
												</div>
...
function check_validation() {
  ...
  var kode_entity = document.getElementById('INV_ENTITY_CODE').value;
  var nama_entity = document.getElementById('INV_ENTITY_NAME').value;
  var alamat_entity = document.getElementById('INV_ENTITY_ALAMAT').value;
  var npwp = document.getElementById('INV_ENTITY_NPWP').value;

  if(kode_entity == "" || nama_entity == "" || alamat_entity == "" || npwp == "") {
...
function check_validation1() {
  //var kode_entity = document.forms['form_add_entity']['INV_ENTITY_CODE'];
  var INV_EMATERAI_NUMBER1 = document.getElementById('INV_EMATERAI_NUMBER1').value;
  var INV_EMATERAI_REDAKSI1 = document.getElementById('INV_EMATERAI_REDAKSI1').value;
  var INV_EMATERAI_EFECTIVE1 = document.getElementById('INV_EMATERAI_EFECTIVE1').value;
  var INV_EMATERAI_END1 = document.getElementById('INV_EMATERAI_END1').value;

  if(INV_EMATERAI_NUMBER1 == "" || INV_EMATERAI_REDAKSI1 == "" || INV_EMATERAI_EFECTIVE1 == "" || INV_EMATERAI_END1 == "") {
    //alert('gak boleh kosong cok');
    $("#blank_form").modal();
  } else {
    //alert(kode_entity);
    $("#allert_materai_update").modal();
  }
}

function check_validation2() {
  //var kode_entity = document.forms['form_add_entity']['INV_ENTITY_CODE'];
  var INV_FAKTUR_NOTE1 = document.getElementById('INV_FAKTUR_NOTE1').value;
  var INV_FAKTUR_EFECTIVE1 = document.getElementById('INV_FAKTUR_EFECTIVE1').value;
  var INV_FAKTUR_EXPIRED1 = document.getElementById('INV_FAKTUR_EXPIRED1').value;

  if( INV_FAKTUR_NOTE1 == "" || INV_FAKTUR_EFECTIVE1 == "" || INV_FAKTUR_EXPIRED1 == "") {
    //alert('gak boleh kosong cok');
    $("#blank_form").modal();
  } else {
    //alert(kode_entity);
    $("#allert_faktur_update").modal();
  }
}
...
<script type="text/javascript">
    ...
    $('#INV_FAKTUR_EFECTIVE1').datepicker({
      autoclose: true,
      format: 'dd/mm/yyyy',
      startDate: '-3d'
    });

    $('#INV_FAKTUR_EXPIRED1').datepicker({
      autoclose: true,
      format: 'dd/mm/yyyy',
      startDate: '-3d'
    });
    $('#INV_EMATERAI_EFECTIVE2').datepicker({
      autoclose: true,
      format: 'dd/mm/yyyy',
      startDate: '-3d'
    });

    $('#INV_EMATERAI_END2').datepicker({
      autoclose: true,
      format: 'dd/mm/yyyy',
      startDate: '-3d'
    });
    $('#INV_EMATERAI_EFECTIVE1').datepicker({
      autoclose: true,
      format: 'dd/mm/yyyy',
      startDate: '-3d'
    });

    $('#INV_EMATERAI_END1').datepicker({
      autoclose: true,
      format: 'dd/mm/yyyy',
      startDate: '-3d'
    });
...
/*
	...
	function savefaktur1()
	{
		...
		$.post( path, {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
			...
			try {
				...
				if (result.status == "success") {
					loaddatafaktur($('[name="ROWID"]').val());
					$("#INV_FAKTUR_NOTE1").val("")
					$("#INV_FAKTUR_EFECTIVE1").val("")
					$("#INV_FAKTUR_EXPIRED1").val("")
	...
	function updatefaktur()
	{
		...
		// INV_FAKTUR_STATUS:INV_FAKTUR_STATUS
			...
			loaddatafaktur($('[name="ROWID"]').val());
			$('#INV_FAKTUR_NOTE2').val("");
			$('#INV_FAKTUR_EFECTIVE2').val("");
			$('#INV_FAKTUR_EXPIRED2').val("");


        });

		$('#update-faktur').modal('hide');
        return false;
	}
