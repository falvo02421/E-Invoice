								...
								<div class="box-body">
									<div class="form-group">
							            <div class="col-sm-offset-12 col-sm-3 text-right">
								              ...
								              <button type="button" onclick="loaddata()" ac class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-search"></i> Search</a></button>
							          		<!-- </div> -->
							            </div>
			      					</div>
			  					</div>
					...
					<table id="mastertable" class="table table-hover">
						<thead>
							<tr>
								...
								<th width="25%">Kode Org</th>
								<th width="45%">Nama Unit</th>
								<th></th>
								<th></th>
							</tr>
						</thead>
		...
		<div class="modal-content">
	        ...
	        <div class="modal-body">
											...
											<form class="form-horizontal">
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text" name="INV_UNIT_ORGID" id="INV_UNIT_ORGID" class="form-control" value="" placeholder="Org ID" value="" data-error="required" required>
															</div>
					...
					<div class="modal-footer">
							<button  type="button"  id="submit" name="submit" onclick="check_validation()" class="btn btn-primary">Save</button>
											...
											<form class="form-horizontal">
												...
												<div class="table-responsive">
													<table id="table-pejabat" class="table table-hover">
														<thead>
																<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#add_notconf"><i class="fa fa-plus"></i></button>
																<br\>
											...
											<form class="form-horizontal">
												...
												<div class="table-responsive">
													<table id="table-redaksi" class="table table-hover">
														<thead>
																<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#add_redaksi"><i class="fa fa-plus"></i></button>
																<br\>
																<!-- <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#update_notconf"><i class="fa fa-pencil-square"></i></button> -->
																<tr>
																	<th>No</th>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab-home">
								<form class="form-horizontal" action="javascript:void(0);" id="formAddNotConf">
									...
									<div class="modal-footer">
										<button  type="button"  id="submit" name="submit" onclick="check_validation1()" class="btn btn-primary">Save</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab-home">
								<form class="form-horizontal" action="javascript:void(0);" id="formEditNotConf">
									...
									<div class="modal-footer">
										<button  type="button"  id="submit" name="submit" onclick="confirmation4()" class="btn btn-primary" data-dismiss="modal">Update</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
									</div>
							</div>
						</div>
		...
		<div class="modal-content">
			...
			<form id="form1">
		            <div class="form-group">
											...
											<form class="form-horizontal">
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<input type="text" name="INV_UNIT_ORGID1" id="INV_UNIT_ORGID1" class="form-control" placeholder="Kode Unit" data-error="tes" required>
															</div>
														</div>
													</div>
												</div>
						...
						<div class="modal-footer">
							<button  type="button"  id="submit" name="submit" onclick="confirmation1()" class="btn btn-primary" data-dismiss="modal">Update</button>
							<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
						</div>
				</div>
			</div>
								...
								<form class="form-horizontal">
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<textarea type="text" value="1234" name="INV_REDAKSI_NOTE1" id="INV_REDAKSI_NOTE1" class="form-control" placeholder="Redaksi Body"></textarea>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="modal-footer">
										<button  type="button"  id="submit" name="submit" onclick="confirmation3()" class="btn btn-primary" data-dismiss="modal">Save</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
									</div>
							</div>
						</div>
								...
								<form class="form-horizontal">
												...
												<div class="box-body">
													<div class="form-group">
														...
														<div class="row">
															<div class="col-xs-5">
																<textarea type="text" value="1234" name="INV_REDAKSI_NOTE2" id="INV_REDAKSI_NOTE2" class="form-control" placeholder="Redaksi Body"></textarea>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="modal-footer">
										<button  type="button"  id="submit" name="submit" onclick="updateredaksiconfirm()" class="btn btn-primary" data-dismiss="modal">Save</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
									</div>
							</div>
						</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           <div style="background-color:#B22222;" class="modal-header">
            ...
            <div class="modal-footer">
            	<button class=" btn btn-primary" id="" onclick="saveunit()">Ya</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           <div style="background-color:#B22222;" class="modal-header">
            ...
            <div class="modal-footer">
            	<button class=" btn btn-primary" id="">Ok</button>
            </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="modal-footer">
            	<button class="btn btn-primary" id="" onclick="updateunit()">Ya</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal">Tidak</button>
            </div>
            </form>
        </div>
...
$( document ).ready(function() {
	...
	function check_validation() {
		...
		if(INV_UNIT_ORGID == "" || INV_UNIT_CODE == "" || INV_UNIT_NAME == "" || INV_UNIT_NAME == "") {
	...
	function confirmation3(){
		var INV_REDAKSI_NOTE = document.getElementById('INV_REDAKSI_NOTE1').value;
		...
		if(INV_REDAKSI_NOTE == "" || INV_REDAKSI_BAWAH == "" || INV_PEJABAT_EFECTIVE == "" || INV_PEJABAT_EXPIRED == ""){
		...
		$.post( path, {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
			...
			for(i=0; i<Object.keys(data1).length; i++){
				...
				html += '<tr>'+
						...
						'<td><button type="button"  onclick="editpejabat(\''+data1[i].INV_PEJABAT_ID+'\')"  class="btn btn-primary btn-lg" data-toggle="modal" data-target="#update_notaconf"><i class="fa fa-pencil-square"></i></button></td>'+
						'</tr>';
			}
			// alert(html);die;
	...
	function saveredaksi()
	{
		...
		$.post( path, {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
			...
			INV_REDAKSI_NOTE 		:INV_REDAKSI_NOTE,
	...
	function updateredaksi()
	{
		...
		var INV_NOTA_JENIS 		= $("#INV_NOTA_LAYANAN2").val();
