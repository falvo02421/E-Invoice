	...
	<div class="col-lg-12">
		<div class="main-box clearfix">
			...
			<div class="box box-primary">
				<div class="box-body">
					<div class="row">
				  		<form class="form-horizontal"  id="form2" action="javascript:void(0)">
							<div class="col-md-6">
								<div class="box-body">
									<div class="form-group">
										<div class="box-body">
											...
											<div class="row">
												<div class="col-xs-5">
						                  			<input type="text" ame="INV_USER_NAME2" id="INV_USER_NAME2" class="form-control" placeholder="Search Username Here..">
						                		</div>
					                		</div>
					             		</div>
				             		</div>
								...
								<div class="box-body">
									<div class="form-group">
							            <div class="col-sm-offset-12 col-sm-3 text-right">
								              <button type="button" onclick="apus()"  class="btn btn-primary btn-sm" data-toggle="" data-target=""> Clear</button>
	...
	<div class="box-body">
		<div class="form-group">
			<div class="text-right" style="padding-right: 20px;">
				<!-- <button class="btn-btn plus" onclick="link_user();"><i class="fa fa-plus"></i></button> -->
			    <button class="btn btn-primary plus add_user" data-toggle="modal" ><i class="fa fa-plus"></i></button>
			</div>
		</div>
	</div>
</div>
...
<div id="add_user" class="modal fade" role="dialog" >
	<div class="modal-dialog">
		...
		<div class="modal-footer">
				<button  type="submit" id="submit" name="submit"  class="btn btn-primary btn_user_save" >Save</button>
...
<div id="update_user" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-footer">
				<button  type="submit" id="submit" name="submit"  class="btn btn-primary btn_user_update" >Update</button>
				<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
		</div>
	    </div>
	    </form>
											...
											<form class="form-horizontal">
												...
												<div class="table-responsive">
													<table id="table-pejabat" class="table table-hover">
														<thead>
																<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_userrole"><i class="fa fa-plus"></i></button>
																<br\>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab-home">
								...
								<div class="box-body">
									...
									<div class="modal-footer">
										<button  type="button"  id="submit" name="submit" onclick="confirmupdaterole()" class="btn btn-primary" data-dismiss="modal">Save</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
									</div>
							</div>
						</div>
...
$( document ).ready(function() {
		...
		"ajax": {
					...
					"data":function (data){
					       ...
					       data.INV_USER_NAME=INV_USER_NAME;
					     },
		},
		...
		$.post( path, {'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
			...
			for(i=0; i<Object.keys(data1).length; i++){
				...
				html += '<tr>'+
						...
						// '<td>'+data1[i].INV_USER_NOTE+'</td>'+
						'<td><button type="button" id="INV_NOTA_CODE3" name="INV_NOTA_CODE3" onclick="edituserrole(\''+$id+'\')"  value="" class="btn btn-primary " data-toggle="modal" data-target="update_userrole"><i class="fa fa-pencil-square"></i></button></td>'+
						'</tr>';
			}
			// alert(html);die;
