...
function submitheader()
{
	...
	EMAIL:email,KIU:kiu,EXPIRED_KIU:expired_kiu,NO_STNK:no_stnk,EXPIRED_STNK:expired_stnk,EXPIRED_DATE:expired_date,RFID_CODE:rfid_code,ASSOCIATION_COMPANY:association_company,'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'},
								...
								<header class="main-box-header clearfix">
									...
									<div class="main-box-body clearfix">
										<div class="form-group">
												...
												<option value="IDPLM-PLMD">Palembang</option>
												</select>
										</div>
										...
										<div class="form-group example-twitter-oss">
											...
											<div class="form-group col-xs-6">
												...
												<input type="text" class="form-control" id="truck_id" name="truck_id" placeholder="TID" title="Masukkan No RFID Kartu" size="10" value="<?=$request_data[0]['TID']?>" readonly>
											</div>
											<div class="form-group col-xs-6">
											...
											<div class="form-group col-xs-6">
												...
												<input type="text" class="form-control" id="rfid_code" name="rfid_code" placeholder="RFID-Code" title="Masukkan No RFID Kartu" size="10" value="<?=$request_data[0]['RFID_CODE']?>" readonly>
											</div>
											<div class="form-group col-xs-6">
