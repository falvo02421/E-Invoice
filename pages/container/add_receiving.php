  ...
  $("#is_vgmterminal").on('click',function(){
    ...
    function submitheader() {
		...
		*/
		...
		if ((port == "IDJKT-T3I" && peb == "") || (port == "IDPNJ-PNJI" && peb == ""))
		{
		...
		if ((port == "IDJKT-T3I" && peb_dt=="") || (port == "IDPNJ-PNJI" && peb_dt == ""))
        {
		...
		if ((port == "IDJKT-T3I" && npe == "") || (port == "IDPNJ-PNJI" && npe == ""))
		{
		...
		if ((port == "IDJKT-T3I" || port == "IDPNJ-PNJI" ) && booking_ship == "")
		{
		...
		if ((port == "IDJKT-T3I" && $("#peb_upload").val() == "") || (port == "IDPNJ-PNJI" && $("#peb_upload").val() == ""))
		{
		...
		if ((port == "IDJKT-T3I" && $("#npe_upload").val() == "") || (port == "IDPNJ-PNJI" && $("#npe_upload").val() == ""))
		{
			alert("Dokumen NPE Wajib Diupload");
            $( "#npe_upload" ).focus();
            return false;
		}
		if ((port == "IDJKT-T3I" && $("#booking_ship_upload").val() == "") || (port == "IDPNJ-PNJI" && $("#booking_ship_upload").val() == ""))
		{
