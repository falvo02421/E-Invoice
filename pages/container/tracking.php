							...
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<form role="form">
										...
										<div class="form-group">
											<label for="exampleTooltip">Port of Loading / Port of Discharge</label>
											<input type="text" class="form-control" id="exampleTooltip" data-toggle="tooltip" data-placement="bottom" title="Pelabuhan Asal dan Tujuan" size="10" value="<?=$pol.' / '.$pod?>" readonly>
										</div>
										<div class="form-group">
