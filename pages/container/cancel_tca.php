...
$(document).ready(function() {
	...
	$( "#no_container_noneservice" ).autocomplete({
		...
		minLength: 4,
		source: function(request, response) {
			$.getJSON("<?=ROOT?>truck_container/cancel_noneservice",{<?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo
		...
		select: function( event, ui )
		{
			...
			$("#truck_id_" ).val( ui.item.TRUCK_ID);
			$("#pin_number_" ).val( ui.item.PIN_NUMBER);
			$("#truck_number_" ).val( ui.item.TRUCK_NUMBER);
			return false;
		}
	}).data( "uiAutocomplete" )._renderItem = function( ul, item )
	{
	...
	$( "#no_container_eservice" ).autocomplete({
		...
		minLength: 4,
		source: function(request, response) {
			$.getJSON("<?=ROOT?>truck_container/cancel_eservice",{<?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo
	...
	function cancel_tca_association_eservice()
	{
	...
	var url="<?=ROOT?>truck_container/cancel_tca_association";
	$.blockUI();
	...
	function(data) {
		...
		{ 	
			...
			else
			{
				...
				alert("Cancel Truck Berhasil");
				
				window.location = "<?=ROOT?>truck_container/cancel_tca";
	...
	function cancel_tca_association_noneservice()
	{
							...
							<div class="main-box">
								...
								<div class="form-group">
									...
									<div class="form-group col-xs-3">
										...
										<input type="text" class="form-control" id="truck_id" name="truck_id" placeholder="Truck ID" title="Masukkan data customer" size="8" readonly>
									</div>
									<div class="form-group col-xs-3">
										<label for="exampleAutocomplete">Truck Number<font color="red">*</font></label>
										<input type="text" class="form-control" id="truck_number" name="truck_number" placeholder="Plat Number" title="Masukkan data customer" size="8" readonly>
									</div>
									<div class="form-group col-xs-3">
										<label for="exampleAutocomplete">PIN Number<font color="red">*</font></label>
										<input type="text" class="form-control" id="pin_number" name="pin_number" placeholder="PIN Number" title="Masukkan data customer" size="8" value="<?=$request_data[0]['PIN_NUMBER']?>" readonly>
									</div>
									<div>
											  <button id="submit_header" class="btn btn-success" onclick="cancel_tca_association_eservice()">Save</button>
										</div>		
								</div>
								</div>
							</div>
							...
							<div class="main-box">
								...
								<div class="main-box-body clearfix">
									<div class="form-group">
										...
										<div class="form-group col-xs-3">
											<label for="exampleAutocomplete">No Container<font color="red">*</font></label>
											<input type="text" class="form-control" id="no_container_" name="no_container_" placeholder="No Container" title="Masukkan data customer" size="8" readonly>
										</div>
										<div class="form-group col-xs-3">
											<label for="exampleAutocomplete">Truck ID<font color="red">*</font></label>
											<input type="text" class="form-control" id="truck_id_" name="truck_id_" placeholder="Truck ID" title="Masukkan data customer" size="8" readonly>
										</div>
										<div class="form-group col-xs-3">
										<label for="exampleAutocomplete">Truck Number<font color="red">*</font></label>
										<input type="text" class="form-control" id="truck_number_" name="truck_number_" placeholder="Plat Number" title="Masukkan data customer" size="8" readonly>
									</div>
										<div class="form-group col-xs-3">
											<label for="exampleAutocomplete">PIN Number<font color="red">*</font></label>
											<input type="text" class="form-control" id="pin_number_" name="pin_number_" placeholder="PIN Number" title="Masukkan data customer" size="8" readonly>
										</div>
										<div>
											  <button id="submit_header_" class="btn btn-success" onclick="cancel_tca_association_noneservice()">Save</button>
										</div>	  
									</div>
									</div>
