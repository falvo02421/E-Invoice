...
$(document).ready(function() {
	...
	{
		var url = "<?=ROOT?>register/search_customer_deactivation/"+$("#search").val();
...
<script>
	...
	function load_table()
	{
		var url = "<?=ROOT?>register/search_customer_deactivation";
		var limit = $("#pagelimit").val();
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="main-box">
															...
															<div class="main-box-body clearfix">
																...
																<div class="row">
																	<div class="form-group example-twitter-oss col-md-5">
																		...
																		<input type="text" class="form-control" id="simop_customer_name" name="simop_customer_name" data-provide="typeahead" data-toggle="tooltip" data-placement="right" title="Mencocokkan dengan basis data" value=""/>
																		...
																		<input type='hidden' id='npwp_id' name='npwp'/>
															...
															<div class="row">
																<div class="form-group example-twitter-oss col-md-5">
																		<label for="holding" >Alasan Deactivasi Pelanggan</label>
																		<input type="text" class="form-control" id="alasan" name="alasan" />
																</div>
															</div>
															<div class="row">
																<div class="form-group example-twitter-oss col-md-5">
																	<!-- <input type="text" class="form-control" id="npwp" name="main_xx" disabled="" /> -->
																		<input type="file" name="acceptance_doc" class="form-control" id="acceptance_doc" data-toggle="tooltip" data-placement="bottom" title="" size="100" >
																		<?php 
															...
															<div class="row">			
																<div class="form-group">
																	<button type="button" id="submitButton" class="btn btn-success">Deactivate</button>
																</div>
															</div>
														</div>
...
{"company_id":"10400807","company_name":"PT. BAHARI SANDI PRATAMA","address":"JL.JEND.SUDIRMAN NO.21 THEHOK JAMBI, PH.26423\r\n","city":null,"npwp":"02.118.172.2-211.000","value":"PT. BAHARI SANDI PRATAMA"}
	...
	function initSimopName(){
		$('#simop_customer_name').typeahead({
			name: 'simop_customer',
			remote: '<?=ROOT;?>register/testDeactivasi/%QUERY', 	// you can change anything but %QUERY
			...
			template: [
				...
				'<p class="repo-name">Cabang : {{branch}}</p>'
			].join(''),
			engine: Hogan
