				...
				<table class="table table-striped table-hover" id='list_cargo_table1'>
					...
					<tbody>
						<tr>
							...
							<td><select id="pkg_id" name="pkg_id" class="form-control" style="width:200px;"></select></td>
							<td><input type="text" id="qty" name="qty" value="" style="width:60px;" class="form-control"/></td>
							<td><input type="text" id="ton" name="ton" value="" style="width:60px;" class="form-control"/></td>
							<td><input type="text" id="cubic" name="cubic" value="" style="width:60px;" class="form-control"/></td>
							...
							<td><select id="ei" name="ei" class="form-control" style="width:80px;">
